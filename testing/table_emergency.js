'use strict';
    var emergency_requested_devices,columnNames=[];
    emergency_requested_devices = [{
            User: "John",
            ID: 101,
            Device: "Ipad pro",
    ...
    function createHeaderRow() {
        ...
        for (var i in emergency_requested_devices[0]) {
    ...
    function createDataRow(x) {
            ...
            for(var columns=0;columns<columnNames.length;columns++){
                ...
                dataColumn.innerHTML = emergency_requested_devices[x][columnNames[columns]];
    ...
    function createTable(){
        var tbl = document.getElementById('emergency_requested_devices');
        tbl.className = 'table table-bordered';
        tbl.style.width = "auto";
        tbl.appendChild(createHeaderRow());
        for(var x=0;x<emergency_requested_devices.length;x++){
